...
tokenized_tweets = [[word for word in tweet if word not in stop_words] for tweet in tokenized_tweets]
...
classified_sentiments = [classify_sentiment(sentiment['compound']) for sentiment in sentiments]
